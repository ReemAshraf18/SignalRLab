    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Comment>().HasData(
                new Comment { Id = 1, ProductId = 1, UserName = "User1", Content = "Great laptop!" },
                new Comment { Id = 2, ProductId = 1, UserName = "User2", Content = "Worth the price." },
                new Comment { Id = 3, ProductId = 2, UserName = "User3", Content = "Excellent camera quality" }
            );
        }
    }
}